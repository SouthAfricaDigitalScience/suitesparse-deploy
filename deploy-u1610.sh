...
mkdir -p ${SOFT_DIR}/${VERSION}-gcc-${GCC_VERSION}-mpi-${OPENMPI_VERSION}
...
CFLAGS="-L${OPENBLAS_DIR}/lib -L${LAPACK_DIR}/lib" make install INSTALL="${SOFT_DIR}-gcc-${GCC_VERSION}-mpi-${OPENMPI_VERSION}"
