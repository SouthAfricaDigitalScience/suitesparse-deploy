...
sed -i 's@^INSTALL_LIB =.*$@INSTALL_LIB = ${SOFT_DIR}/${VERSION}-gcc-${GCC_VERSION}-mpi-${OPENMPI_VERSION}/lib' SuiteSparse/SuiteSparse_config/SuiteSparse_config.mk
echo "INSTALL LIB dir is : "
grep INSTALL_LIB SuiteSparse/SuiteSparse_config/SuiteSparse_config.mk

sed -i 's@^INSTALL_INCLUDE =.*$@INSTALL_INCLUDE = ${SOFT_DIR}/${VERSION}-gcc-${GCC_VERSION}-mpi-${OPENMPI_VERSION}/include' SuiteSparse/SuiteSparse_config/SuiteSparse_config.mk
